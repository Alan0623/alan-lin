...
!function (t, e, n, o) {
    ...
    if (n) {
        ...
        var a = {
            ...
            i18n: {
                en: {
                    CLOSE: "[esc]關閉燈箱相簿（Close）",
                    NEXT: "下一張圖片（Next）",
                    PREV: "上一張圖片（Previous）",
                    ERROR: "The requested content cannot be loaded. <br/> Please try again later.",
                    PLAY_START: "自動輪播圖片（Start slideshow）",
                    PLAY_STOP: "暫停輪播圖片（Pause slideshow）",
                    FULL_SCREEN: "全螢幕模式 (Full screen）",
                    THUMBS: "圖片列表（Thumbnails）",
        ...
        n.extend(p.prototype, {
            ...
            setBigImage: function (t) {
                var imgAlt = $(".fancybox-caption").text();
                var e = this
                    , o = n("<img />");
